...
TARGET_PLATFORM=armv7l-linux-musleabihf-cross
TARGET_PLATFORM_REPO=https://airtake-public-data-1254153901.cos.ap-shanghai.myqcloud.com/smart/embed/pruduct/armv7l-linux-musleabihf-cross_.zip
