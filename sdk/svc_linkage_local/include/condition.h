...
#define CTT_TIMER 3 
#define CTT_SPEC_EXPRESSION 4 //非dp的表达式#endif
/* dp expression */
...
#if defined(ENABLE_LAN_LINKAGE_MASTER) && (ENABLE_LAN_LINKAGE_MASTER==1)
typedef OPERATE_RET (*COND_CHECK_GW_ID_FUNC)(IN CONST CHAR_T *gw_id);

__CONDITION_EXT \
OPERATE_RET conditions_check_gw_id(IN CONST ty_cJSON *root, IN COND_CHECK_GW_ID_FUNC check_func);
#endif
